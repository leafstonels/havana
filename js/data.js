...
addWinner("off8", "first", "Juraij", 2, 5);
addWinner("off8", "second", "Fathima Farha K", 3, 3);
addWinner("off8", "third", "Mohammed Sidan MK", 3, 1);
...
addWinner("off14", "first", "Mohammed Rashid", 2, 5);
addWinner("off14", "second", "Juraij", 2, 3);
...
addWinner("off17", "first", "Varsha-Rinsila", 3, 5);
addWinner("off17", "second", "Rinshad-Aneena", 1, 3);
addWinner("off17", "third", "Ramin-Shamil", 1, 1);
